...
    else:
        st.warning(f"⚠️ El jugador no registra partidos oficiales recientes. Proyección basada en promedio general ({stats_season['avg_season']:.3f}).")    quiero que mejore el analisis se puede o que se puede implementar para mejorar 
